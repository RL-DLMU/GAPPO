from common.utils_0 import build_index_intersection_map
...
class Graph_World_Interface(Interface):
    ...
    def __init__(self, roadnet_path,flow_path):
        super(Graph_World_Interface, self).__init__()
        # TODO: support other roadnet file formation other than cityflow
        Graph_World_Interface.graph = build_index_intersection_map(roadnet_path, flow_path)
