...
##################################################################################################################
                # print(f"Step {i}, LightID {lightID}, Current Phase: {current_phase}")  # 打印当前相位
########################################################
...
########################################################
    ...
    def get_lane_vehicle_count(self):
        ...
        return result
######################################################################################################################
    # def get_lane_vehicle_count_use_intersections_idx(self, intersections_idx):
    #     '''
    #     get_lane_vehicle_count
    #     Get number of vehicles in each lane.
    ...
    #     result = dict()
    #     for intsec in self.intersections:
    #         if intsec.id == intersections_idx:
    #             for lane in intsec.lanes:
    #                 result.update({lane: intsec.full_observation[lane]['lane_count']})
    #     return result
###########################################################
