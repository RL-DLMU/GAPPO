...
def parse_args():
    ...
    # parser.add_argument("--or_sumonet", type=str,
    #                     default='sumo1_4/1_4_twoLane.net.xml')
    # parser.add_argument("--cityflownet", type=str,
    #                     default='sumo1_4/1_4_roadnet.json')
    # parser.add_argument("--or_sumotraffic", type=str,
    #                     default='sumo1_4/1_4_twoLane.rou.xml')
    # parser.add_argument("--cityflowtraffic", type=str,
    #                     default='sumo1_4/1_4_flow.json')
    # parser.add_argument("--sumocfg", type=str,
    #                     default='sumo1_4/sumo1_4.sumocfg')
#######################################################################################################
    parser.add_argument("--or_sumonet", type=str,
                        default=r'D:\01_路网\shanghai8\roadnet.net.xml')
    parser.add_argument("--cityflownet", type=str,
                        default=r'D:\01_路网\shanghai8\roadnet.json')
    parser.add_argument("--or_sumotraffic", type=str,
                        default=r'D:\01_路网\shanghai8\flow.rou.xml')
    parser.add_argument("--cityflowtraffic", type=str,
                        default=r'D:\01_路网\shanghai8\flow.json')
    parser.add_argument("--sumocfg", type=str,
                        default=r'D:\01_路网\shanghai8\roadnet.sumocfg')
###################################################
...
#######################################################################################################
    # parser.add_argument("--or_cityflownet", type=str,
    #                     default=r'D:\01_路网\sumo_manhattan_16x3\roadnet_16_3.json')
    # parser.add_argument("--sumonet", type=str,
    #                     default=r'D:\01_路网\sumo_manhattan_16x3\roadnet_16_3.net.xml')
    # parser.add_argument("--or_cityflowtraffic", type=str,
    #                     default=r'D:\01_路网\sumo_manhattan_16x3\anon_16_3_newyork_real.json')
    # parser.add_argument("--sumotraffic", type=str,
    #                     default=r'D:\01_路网\sumo_manhattan_16x3\anon_16_3_newyork_real.rou.xml')
...
def sumo2cityflow_flow(args):
    ...
    for obj in root.iter('flow'):
        rou_id = obj.attrib['route']
        routes = root.find(f".//route[@id='{rou_id}']").get('edges')
        num = obj.attrib['number']
        # routes = rou0.get('edges')
        if len(routes) < 2:
            continue
        veh = {
            "vehicle": {
            ...
            "route": routes,
            "interval": 1.0,
            "startTime": int(float(obj.attrib['begin'])) - start_time,
            "endTime": int(float(obj.attrib['begin'])) - start_time
        }
        veh_flow = list(itertools.repeat(veh, int(num)))
        flows = veh_flow + flows
        # flows.append(veh_flow)
